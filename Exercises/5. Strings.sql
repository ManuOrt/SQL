-- 1) Find the department names that consist of four characters and a period followed by another four characters and another period.

SELECT dept_name FROM department WHERE dept_name LIKE '____. ___.';

-- 2) Find the department names that have a blank space in their name.

SELECT dept_name FROM department WHERE dept_name LIKE '% %';
...
SELECT dept_name FROM department WHERE dept_name LIKE '_______';
